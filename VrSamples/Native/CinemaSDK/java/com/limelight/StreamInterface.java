...
public class StreamInterface implements SurfaceHolder.Callback,
     NvConnectionListener, EvdevListener,
     GameGestures, StreamView.InputCallbacks
{
    ...
    public StreamInterface(MainActivity creatingActivity, String compUUID, String appName, int appId, String uniqueId, SurfaceHolder sh, int width, int height, int fps, boolean hostAudio, boolean remote) {
        ...
        prefConfig.enable51Surround = true;

        tombstonePrefs = activity.getSharedPreferences("DecoderTombstone", 0);
        ...
        int gamepadMask = ControllerHandler.getAttachedControllerMask(activity);
        ...
        if (!decoderRenderer.isAvcSupported()) {
            ...
            /*Dialog.displayDialog(this, activity.getResources().getString(R.string.conn_error_title),
                    "This device or ROM doesn't support hardware accelerated H.264 playback.", true);*/
            return;
        }
        decoderRenderer.setRenderTarget(sh);
...
/*
    ...
    public void stageStarting(String stage) {
        if (spinner != null) {
            spinner.setMessage(activity.getResources().getString(R.string.conn_starting)+" "+stage);
        }
    }
    ...
    public void stageFailed(String stage, long errorCode) {
        ...
        if (!displayedFailureDialog) {
            ...
            /*Dialog.displayDialog(this, activity.getResources().getString(R.string.conn_error_title),
                    activity.getResources().getString(R.string.conn_error_msg)+" "+stage, true);*/
        }
    }
    ...
    public void displayMessage(final String message) {
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                //Toast.makeText(StreamInterface.this, message, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        if (!attemptedConnection) {
            ...
            conn.start(PlatformBinding.getAudioRenderer(), decoderRenderer, StreamInterface.this);
        }
    }
